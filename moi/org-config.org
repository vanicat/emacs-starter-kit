...
#+begin_src emacs-lisp
  ...
  (setq org-contacts-files '("~/org/concact.org"))
#+end_src
* from custom
  :PROPERTIES:
  ...
  :END:
#+begin_src emacs-lisp
  (setq org-agenda-files (quote ("~/org/prgm.org" "~/org/notes.org" "~/org/mononoke.org" "~/org/personel.org" "~/org/aniversaire.org" "~/org/cours.org" "~/travail/snd/2010_201/notes-snd-01.org" "~/travail/snd/mps/mps.org" "~/travail/premiere/2010-2011 S/note-1S2-2010.org" "~/travail/premiere/2010-2011 STG/note-stg-10.org")))
